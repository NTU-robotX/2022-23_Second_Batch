...
def generate_gps_data():
    ...
    # Other fields
    team_id = "ROBOT"
    uav_status = "2"  # Assuming Autonomous mode

    # You would include your method of calculating the checksum
    checksum = "0D"

    return f"$UAVGPSDATA,{aedt_date},{aedt_time},{object_reported},{latitude},{ns_indicator},{longitude},{ew_indicator},{object_reported},{latitude},{ns_indicator},{longitude},{ew_indicator},{team_id},{uav_status}*{checksum}"
